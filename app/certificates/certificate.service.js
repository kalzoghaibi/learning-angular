...
var CertificateService = (function () {
    function CertificateService(_http) {
        this._http = _http;
        this._certUrl = 'api/certificates/certificates.json';
    }
    ...
    CertificateService.prototype.getCertificate = function (id) {
        return this.getCertificates()
            .map(function (certificates) { return certificates.find(function (p) { return p.certID === id; }); });
    };
